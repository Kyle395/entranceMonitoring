...
namespace EntranceMonitoring.Controllers
{
    public class BuildingsController : Controller
    {
        ...
        public BuildingsController(MonitoringContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BuildingId,Name,Address")] Building building)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BuildingId,Name,Address")] Building building)
        {
